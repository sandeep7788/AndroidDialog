...
public class AndroidDialog extends Dialog implements View.OnClickListener {
    ...
    public AndroidDialog(Context context, int theme) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = View.inflate(getContext(), com.sandeep.AndroidDialog.R.layout.layout_colordialog, null);
        ...
        if (null == mPositiveListener && null == mNegativeListener) {
            ...
            mNegativeBtn.setBackgroundDrawable(getContext().getResources().getDrawable(R.drawable.sel_def_gray_left));
        } else if (null != mPositiveListener && null == mNegativeListener ) {
            mNegativeBtn.setVisibility(View.GONE);
            mDividerView.setVisibility(View.GONE);
            mPositiveBtn.setBackgroundDrawable(getContext().getResources().getDrawable(R.drawable.shape_right_bottom_normal));
        }
    ...
    public AndroidDialog setAnimationEnable(boolean enable) {
        mIsShowAnim = enable;
        return this;
    }

    public AndroidDialog setAnimationIn(AnimationSet animIn) {
        mAnimIn = animIn;
        return this;
    }

    public AndroidDialog setAnimationOut(AnimationSet animOut) {
        mAnimOut = animOut;
        initAnimListener();
        return this;
    }

    public AndroidDialog setColor(int color) {
        mBackgroundColor = color;
        return this;
    }

    public AndroidDialog setColor(String color) {
        try {
    ...
    public AndroidDialog setTitleTextColor(String color) {
        try {
    ...
    public AndroidDialog setContentTextColor(String color) {
        try {
    ...
    public AndroidDialog setPositiveListener(CharSequence text, OnPositiveListener l) {
        mPositiveText = text;
        mPositiveListener = l;
        return this;
    }

    public AndroidDialog setPositiveListener(int textId, OnPositiveListener l) {
        return setPositiveListener(getContext().getText(textId), l);
    }

    public AndroidDialog setNegativeListener(CharSequence text, OnNegativeListener l) {
        mNegativeText = text;
        mNegativeListener = l;
        return this;
    }

    public AndroidDialog setNegativeListener(int textId, OnNegativeListener l) {
        return setNegativeListener(getContext().getText(textId), l);
    }

    public AndroidDialog setContentText(CharSequence text) {
        mContentText = text;
        return this;
    }

    public AndroidDialog setContentText(int textId) {
        return setContentText(getContext().getText(textId));
    }

    public AndroidDialog setContentImage(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }

    public AndroidDialog setContentImage(Bitmap bitmap) {
        mContentBitmap = bitmap;
        return this;
    }

    public AndroidDialog setContentImage(int resId) {
        mResId = resId;
        return this;
    }
    ...
    public interface OnPositiveListener {
        void onClick(AndroidDialog dialog);
    }
